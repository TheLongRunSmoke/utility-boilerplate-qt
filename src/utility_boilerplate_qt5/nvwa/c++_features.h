...
#if __cplusplus >= 201703L || (defined(_MSC_VER) && _MSC_VER >= 1910 && _MSVC_LANG >= 201703)
...
// 10.14.
    ...
    && (defined(__MAC_OS_X_VERSION_MIN_REQUIRED) && __MAC_OS_X_VERSION_MIN_REQUIRED < 101400)
...
#    if NVWA_CXX11_MODE && ((__has_include(<atomic>) && !defined(__MINGW32__)) || \
...
#    if NVWA_CXX11_MODE                                                             \
        && (__has_feature(cxx_auto_type) || (defined(_MSC_VER) && _MSC_VER >= 1600) \
...
#    if NVWA_CXX11_MODE                                                                     \
        && (__has_feature(cxx_deleted_functions) || (defined(_MSC_VER) && _MSC_VER >= 1800) \
            || (defined(__GNUC__) && __GNUC__ * 100 + __GNUC_MINOR__ >= 404))
...
#    if NVWA_CXX11_MODE                                                                        \
        && (__has_feature(cxx_explicit_conversions) || (defined(_MSC_VER) && _MSC_VER >= 1900) \
            || (defined(__GNUC__) && __GNUC__ * 100 + __GNUC_MINOR__ >= 405))
...
#    if NVWA_CXX11_MODE                                                                    \
        && (__has_feature(cxx_override_control) || (defined(_MSC_VER) && _MSC_VER >= 1700) \
...
#    if NVWA_CXX11_MODE && ((__has_include(<future>) && !defined(__MINGW32__)) || \
     (defined(_MSC_VER) && _MSC_VER >= 1700) || \
     (((defined(__GNUC__) && __GNUC__ * 100 + __GNUC_MINOR__ >= 405) || \
       defined(__clang__)) && \
      (!defined(__MINGW32__) || defined(_POSIX_THREADS))))
...
#    if NVWA_CXX11_MODE                                                                            \
        && (__has_feature(cxx_generalized_initializers) || (defined(_MSC_VER) && _MSC_VER >= 1800) \
            || (defined(__GNUC__) && __GNUC__ * 100 + __GNUC_MINOR__ >= 404))
...
#    if NVWA_CXX11_MODE                                                           \
        && (__has_feature(cxx_lambdas) || (defined(_MSC_VER) && _MSC_VER >= 1600) \
            || (defined(__GNUC__) && __GNUC__ * 100 + __GNUC_MINOR__ >= 405))
...
#    if NVWA_CXX11_MODE && ((__has_include(<mutex>) && !defined(__MINGW32__)) || \
     (defined(_MSC_VER) && _MSC_VER >= 1700) || \
...
#    if NVWA_CXX11_MODE                                                            \
        && (__has_feature(cxx_noexcept) || (defined(_MSC_VER) && _MSC_VER >= 1900) \
...
#    if NVWA_CXX11_MODE                                                           \
        && (__has_feature(cxx_nullptr) || (defined(_MSC_VER) && _MSC_VER >= 1600) \
            || (defined(__GNUC__) && __GNUC__ * 100 + __GNUC_MINOR__ >= 406))
...
#    if NVWA_CXX11_MODE                                                                    \
        && (__has_feature(cxx_override_control) || (defined(_MSC_VER) && _MSC_VER >= 1600) \
            || (defined(__GNUC__) && __GNUC__ * 100 + __GNUC_MINOR__ >= 407))
...
#    if NVWA_CXX11_MODE                                                             \
        && (__has_feature(cxx_range_for) || (defined(_MSC_VER) && _MSC_VER >= 1700) \
            || (defined(__GNUC__) && __GNUC__ * 100 + __GNUC_MINOR__ >= 406))
...
#    if NVWA_CXX11_MODE                                                                     \
        && (__has_feature(cxx_rvalue_references) || (defined(_MSC_VER) && _MSC_VER >= 1600) \
            || (defined(__GNUC__) && __GNUC__ * 100 + __GNUC_MINOR__ >= 405))
...
#    if NVWA_CXX11_MODE                                                                 \
        && (__has_feature(cxx_static_assert) || (defined(_MSC_VER) && _MSC_VER >= 1600) \
            || (defined(__GNUC__) && __GNUC__ * 100 + __GNUC_MINOR__ >= 403))
...
#    if NVWA_CXX11_MODE && ((__has_include(<thread>) && !defined(__MINGW32__)) || \
     (defined(_MSC_VER) && _MSC_VER >= 1700) || \
     (((defined(__GNUC__) && __GNUC__ * 100 + __GNUC_MINOR__ >= 404) || \
       defined(__clang__)) && \
      (!defined(__MINGW32__) || defined(_POSIX_THREADS))))
...
#    if NVWA_CXX11_MODE                                                                \
        && (__has_feature(cxx_thread_local) || (defined(_MSC_VER) && _MSC_VER >= 1900) \
...
#    if NVWA_CXX11_MODE && (__has_include(<type_traits>) || \
     (defined(_MSC_VER) && _MSC_VER >= 1600) || \
     (defined(__GNUC__) && __GNUC__ * 100 + __GNUC_MINOR__ >= 403))
...
#    if NVWA_CXX11_MODE                                                                    \
        && (__has_feature(cxx_unicode_literals) || (defined(_MSC_VER) && _MSC_VER >= 1900) \
            || (defined(__GNUC__) && __GNUC__ * 100 + __GNUC_MINOR__ >= 405))
...
#    if NVWA_USES_CXX17 && (__has_include(<string_view>) || \
...
#    if NVWA_USES_CXX17 && ((__has_include(<any>) && !NVWA_USES_CRIPPLED_CLANG) || \
     (defined(_MSC_VER) && _MSC_VER >= 1910) || \
     (defined(__GNUC__) && __GNUC__ * 100 + __GNUC_MINOR__ >= 700))
...
#    if NVWA_USES_CXX17 && ((__has_include(<optional>) && !NVWA_USES_CRIPPLED_CLANG) || \
     (defined(_MSC_VER) && _MSC_VER >= 1910) || \
     (defined(__GNUC__) && __GNUC__ * 100 + __GNUC_MINOR__ >= 700))
...
#    if NVWA_USES_CXX17 && ((__has_include(<variant>) && !NVWA_USES_CRIPPLED_CLANG) || \
     (defined(_MSC_VER) && _MSC_VER >= 1910) || \
     (defined(__GNUC__) && __GNUC__ * 100 + __GNUC_MINOR__ >= 700))
