...
namespace ubTestSuit {
    ...
    TEST_F(UiFixture, SettingItem_ComboBoxItemWithData) { // NOLINT(cert-err58-cpp)
        ...
        auto* item = new ComboBoxItemWithData(
                "key",
                "name",
                map);
    ...
    TEST_F(UiFixture, SettingItem_ComboBoxItemWithData_defaultValue) { // NOLINT(cert-err58-cpp)
    ...
    TEST_F(UiFixture, SettingItem_ComboBoxItemWithData_value) { // NOLINT(cert-err58-cpp)
