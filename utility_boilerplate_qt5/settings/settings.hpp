...
public:
    ...
    */
     ...
     * Note, toolbar mast have unique name set by setObjectName() to save-restore correctly.
     *
     * @return nullptr if empty.
     */
...
protected:
    ...
    /**
     * List of user settings. Initialized in createBasicSettings() and createUserSettings().
     */
...
private:
     ...
     *
     * @return list, guaranty has "en" key. Key is 2 chars language code, value - user-friendly language name.
     */
     ...
     *
     * If this list do not have entry for some key availableLanguages() return english name of that language.
     */
